...
- `js/record-model.js` — legacy record-tuple adapter, collection/wishlist record construction, rating metadata application, pure track-duration mutation and local shelf-order helpers.
