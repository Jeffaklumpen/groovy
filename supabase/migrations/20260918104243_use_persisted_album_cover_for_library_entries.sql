...
revoke all on function public.save_album_to_library_verified(
  uuid,text,text,text,text,integer,text,text,text,text,jsonb
) from public, anon, authenticated;

grant execute on function public.save_album_to_library_verified(
  uuid,text,text,text,text,integer,text,text,text,text,jsonb
) to service_role;
