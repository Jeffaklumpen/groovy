...
test('pure dependency scripts load before app.js',()=>{
  ...
  ['/js/notification-core.js?v=','/js/pressing-core.js?v=','/js/rating-core.js?v=','/js/marketplace-core.js?v=','/js/shelf-core.js?v=','/js/apple-search-core.js?v='].forEach((script)=>{
